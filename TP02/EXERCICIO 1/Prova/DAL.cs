    ...
    class DAL
    {
        ...
        public static void getProximo()
        {
            ...
            if (result.Read())
            {
                ...
                //var teste = result.GetValue(2);
                //var teste2 = teste;
                VendaCliente.setCodigo(result.GetInt32(2));
                VendaCliente.setData(result.GetString(3));
                VendaCliente.setToneladas(result.GetString(4));
                VendaCliente.setvalor(result.GetString(5));
            }
            else
                Erro.setErro(true);
        }
